...
const terms = [
  {
    ...
    type: "service_terms",
    title: "영업사원 회원가입 이용약관",
    version: "1.0",
    requiredYn: "Y",
    content: `제1조 목적
본 약관은 마루 파트너 관리 시스템의 영업사원 계정 가입, 이용, 고객 관리 활동에 필요한 기본 조건과 절차를 정합니다.

제2조 계정 가입
영업사원은 본인 정보를 입력하고 필수 약관에 동의한 뒤 회원가입을 신청할 수 있습니다. 가입된 영업사원 계정은 admin 하위로 등록됩니다.

제3조 가입 링크 및 고객 관리
영업사원은 본인의 UID가 포함된 상조 가입 링크를 생성하여 고객에게 전달할 수 있습니다. 해당 링크를 통해 가입한 상조 회원은 영업사원의 하위 회원으로 연결됩니다.

제4조 준수 사항
영업사원은 고객에게 정확한 정보를 안내해야 하며, 허위 또는 과장 안내, 부정 가입 유도, 개인정보의 무단 이용을 해서는 안 됩니다.

제5조 계정 제한
운영자는 약관 위반, 부정 이용, 고객 민원 등 필요한 사유가 있는 경우 영업사원 계정 이용을 제한하거나 비활성화할 수 있습니다.`,
  },
  {
    scope: "sales_register",
    type: "privacy_policy",
    title: "영업사원 개인정보 수집 및 이용 동의",
    version: "1.0",
    requiredYn: "Y",
    content: `1. 수집 및 이용 목적
영업사원 회원가입, 본인 확인, 계정 관리, 고객 배정 및 관리, 활동 이력 확인, 커미션 및 정산 안내, 민원 대응을 위해 개인정보를 수집 및 이용합니다.
...
3. 보유 및 이용 기간
영업사원 계정 유지 및 관련 업무 처리 목적 달성 시까지 보유합니다. 단, 정산 확인, 분쟁 처리, 법령상 의무 이행이 필요한 경우 해당 기간 동안 보관할 수 있습니다.

4. 동의 거부 권리
필수 개인정보 수집 및 이용에 대한 동의를 거부할 수 있으나, 이 경우 영업사원 회원가입 및 계정 이용이 제한될 수 있습니다.`,
  },
  {
    scope: "sales_register",
    type: "marketing_consent",
    title: "영업사원 마케팅 수신 동의",
    version: "1.0",
    requiredYn: "N",
    content: `1. 이용 목적
